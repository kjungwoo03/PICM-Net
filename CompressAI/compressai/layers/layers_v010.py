...
class ResidualBlockWithStrideDivide(nn.Module):
    ...
    def forward(self, x, index_channel=0):
        ...
        # print(f"\tResidualBlockWithStrideDivide Out1.shape: {out.shape}")
        out = self.leaky_relu(out)
        out = self.conv2(out, index_channel)
        # print(f"\t ResidualBlockWithStrideDivide Out2.shape: {out.shape}")
        out = self.gdn(out, index_channel)
        # print(f"\t ResidualBlockWithStrideDivide Out3.shape: {out.shape}")
