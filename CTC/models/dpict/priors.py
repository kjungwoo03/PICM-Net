...
from .util import conv, deconv, update_registered_buffers
...
class CompressionModel(nn.Module):
    ...
    def load_state_dict(self, state_dict, pass_update=False):
...
class ScaleHyperprior(CompressionModel):
    ...
    def load_state_dict(self, state_dict, pass_update=False):
        ...
        super().load_state_dict(state_dict, pass_update=pass_update)
